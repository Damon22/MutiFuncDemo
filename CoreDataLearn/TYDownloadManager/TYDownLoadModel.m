...
{
    return [self initWithURLString:URLString filePath:nil fileName:nil];
}
...
- (NSString *)downloadDirectory
{
    if (!_downloadDirectory) {
        ...
        //_downloadDirectory = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES) lastObject] stringByAppendingPathComponent:@"offlinedata"];
    }
